...
# بارگذاری عکس‌ها
try:
    snake_head_img = pygame.image.load(r"G:\python\ماربازی\Untitled2.png")
    snake_head_img = pygame.transform.scale(snake_head_img, (HEAD_SIZE, HEAD_SIZE))
except:
    print("خطا در بارگذاری عکس سر مار!")

try:
    food_img = pygame.image.load(r"G:\python\ماربازی\Untitled3.png")
...
while True:
    ...
    pygame.display.set_caption(f'Snake Game: {score}')
